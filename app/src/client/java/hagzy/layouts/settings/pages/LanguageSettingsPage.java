...
public class LanguageSettingsPage extends ScrollView {

    private final Context context;

    public LanguageSettingsPage(Context context) {
        super(context);
    ...
    private void buildPage() {
        ...
        List<LanguageOption> options = Arrays.asList(
                new LanguageOption(t("settings.arabic"), "ar_AR"),
                new LanguageOption(t("settings.english"), "en_US")
        );
